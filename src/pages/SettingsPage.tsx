...
const labels = {
  ...
  en: ['Notifications','Debts and payments','Budget limits','Savings goals','Scheduled reminders','Default currency','Financial period','Start day','Category management','Income categories','Expense categories','New category','Add','Data management','Backup','Restore','Export CSV','Security','Hide amounts in notifications','Clear all data','Delete all financial data? This cannot be undone.','Restoring will replace current data. Continue?','Data restored successfully.','The file is invalid or damaged.','Enable notifications'],
...
export function SettingsPage() {
  ...
  const { preferences, setCurrency, updatePreferences, restoreFinanceData, clearAllData } = finance
